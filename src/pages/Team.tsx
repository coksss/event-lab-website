...
const Team = () => {
  ...
  const teamCats = [
    ...
    {
      name: "Леди Когтеграфику",
      role: "Креативный директор",
      image:
        "https://images.unsplash.com/photo-1596854407944-bf87f6fdd49e?w=300&h=300&fit=crop&crop=face",
      description:
        "В антикварном магазине, среди винтажных обоев и позолоченных рам, жила рыжая кошка с необычным хобби — она перекраивала реальность. Владелец магазина долго не мог понять, откуда берутся таинственные узоры на дорогих тканях, пока не застал её за работой. Она выстригала лапой идеальные кружева из бархатного портьера! Рисовала вензеля когтями на обоях (клиенты принимали это за «авторский винтаж») и собирала инсталляции из разбитых ваз и перьев (назвала это «Кошачий барокко»). Теперь её талант — гордость EventyLab.",
      skills: ["Винтажный дизайн", "Кружевное искусство", "Кошачий барокко"],
      experience: "4 года",
